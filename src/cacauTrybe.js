...
const testCreateChocolateAndGetChocolateById = () => {
  const result =createChocolate('sonho de valsa', 1)
  const result2 = getChocolateById(1)
  return result2 == {name: 'sonho de valsa', branId: 1}
}
